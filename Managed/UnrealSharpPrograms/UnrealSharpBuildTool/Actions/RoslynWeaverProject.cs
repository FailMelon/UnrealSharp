...
public class RoslynWeaverProject : BuildToolAction
{
    readonly string _outputDirectory;
    readonly BuildConfig _buildConfig;

    public RoslynWeaverProject(string outputDirectory = "", BuildConfig buildConfig = BuildConfig.Debug)
    {
    ...
    {
        string weaverPath = Program.GetRoslynWeaver();
